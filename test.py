...
gasoline_timeline = [60 for i in range(14*30+1)] + np.cumsum(np.random.normal(0, 1, 14*30+1))
oil_timeline = [70 for i in range(14*30+1)] + np.cumsum(np.random.normal(0, 1, 14*30+1))
food_cpi = [30 for i in range(14*30+1)] + np.cumsum(np.random.normal(0, 1, 14*30+1))
food_off_pce = [20 for i in range(14*30+1)] + np.cumsum(np.random.normal(0, 1, 14*30+1))
...
for i in range(59):
    ...
    predict_core_pce = lr.predict(np.array([[predict_core_cpi]]))[0][0]
    core_pce.append(predict_core_pce)
    core_pce[-1]=cal_MA(core_pce, 12*30)
